...
SLIDES = [
    ("login",      "01_login",      "أدِر فريقك من هاتفك",  "حضور ورواتب وإجازات",
                                     "Run your team from your phone", "Attendance, payroll & leaves"),
    ("dashboard",  "02_dashboard",  "تابع شركتك في لمحة",   "حضور مباشر وأهم المؤشرات",
                                     "Your company at a glance",      "Live attendance & key metrics"),
    ("employees",  "03_employees",  "أدِر كل موظفيك",       "فروع وأقسام ومستندات",
                                     "Manage all your employees",     "Branches, categories & documents"),
    ("attendance", "04_attendance", "حضور وانصراف دقيق",    "سجلّات وتسجيل يدوي و QR",
                                     "Accurate attendance",           "Records, manual entry & QR"),
    ("payroll",    "05_payroll",    "رواتب وكشوف أجر",      "بدلات وخصومات واعتماد",
                                     "Payroll & payslips",            "Allowances, deductions & approval"),
    ("more",       "06_more",       "كل أدواتك في مكان",    "إجازات · سلف · عُهد · تقارير",
                                     "Every tool in one place",       "Leaves · advances · assets · reports"),
    ("reports",    "07_reports",    "تقارير جاهزة",         "حضور ورواتب وموظفون",
                                     "Ready-made reports",            "Attendance, payroll & employees"),
    ("company",    "08_company",    "تحكّم كامل بإعداداتك",  "تأمينات · فروع · صلاحيات · شِفتات",
                                     "Full control of your setup",    "Insurance · branches · roles · shifts"),
    ("profile",    "09_profile",    "ملف موظف متكامل",      "بيانات ورواتب ومستندات",
