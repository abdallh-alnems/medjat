...
class AuditActions {
  ...
  static const Map<String, _ActionInfo> _actions = {
    ...
    'station.create': _ActionInfo('أنشأ محطة', 'attendance'),
    'station.update': _ActionInfo('عدّل محطة', 'attendance'),
    'station.delete': _ActionInfo('حذف محطة', 'attendance'),
    'station.unlock': _ActionInfo('فتح قفل محطة', 'attendance'),
    'station.regenerate_qr': _ActionInfo('أعاد توليد رمز المحطة', 'attendance'),
    ...
    'branch.update_station_settings': _ActionInfo('عدّل إعدادات محطات فرع', 'settings'),
    ...
    'export_template.create': _ActionInfo('أنشأ قالب تصدير', 'settings'),
    'export_template.update': _ActionInfo('عدّل قالب تصدير', 'settings'),
    'export_template.delete': _ActionInfo('حذف قالب تصدير', 'settings'),
