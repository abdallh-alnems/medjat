# Permedjat Central — تطبيق الإدارة والموارد البشرية

تطبيق **Flutter** للمديرين والموارد البشرية في الشركات العميلة ضمن منصّة **Permedjat** لإدارة الحضور والرواتب (HR SaaS) الموجّهة لسوق مصر وشمال إفريقيا. هو **مركز التحكّم الكامل للشركة**: إدارة الموظفين والفروع والورديات والإجازات وتشغيل الرواتب والتقارير. يدعم العربية (RTL) والإنجليزية (LTR).
...
- **سجل التدقيق** (Audit Log) و**الدعم الفني** (Support): تذاكر ومحادثة مع فريق Permedjat.
