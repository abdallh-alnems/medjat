...
class ApiMessages {
  ...
  static const Map<String, String> _map = {
    ...
    'FACE_MODEL_MISMATCH': 'face_reenroll_required',
    'FACE_INVALID_CHALLENGE': 'face_challenge_expired',
    'FACE_LIVENESS_FAILED': 'face_liveness_failed',
    'FACE_BELOW_THRESHOLD': 'face_not_recognized',
    'FACE_BAD_EMBEDDING': 'face_capture_failed',
    'FACE_QUALITY_TOO_LOW': 'face_quality_too_low',
    'FACE_REQUIRED': 'face_required_for_checkout',
    'WIFI_NOT_ON_WIFI': 'wifi_not_connected',
    'WIFI_WRONG_NETWORK': 'wifi_wrong_network',
