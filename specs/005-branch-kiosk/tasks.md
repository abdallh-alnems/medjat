...
- [X] T094 Create the two Firebase Remote Config parameters `medjat_kiosk_min_version` and `medjat_kiosk_maintenance_enabled` in project `permedjat` — without them the kiosk entry resolves to `0.0.0` and no version gate exists
