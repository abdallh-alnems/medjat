...
**Base path**: all paths are under `front_end/medjat_central_web/` unless noted.
...
- [X] T001 Scaffold Next.js 16 App-Router TS app at `front_end/medjat_central_web/` (src dir, ESLint) per quickstart.md
