...
$count = ShiftModel::unassignEmployees($shiftId, $employeeIds, $tenantId);

AuditLogModel::log($tenantId, $auth['admin_id'], 'shift.unassign', 'shift', $shiftId, ['count' => $count]);

Response::success(['unassigned' => $count]);
